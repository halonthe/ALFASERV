...
Isadmin=$(curl -sS https://raw.githubusercontent.com/halonthe/permission/main/ip | grep $MYIP | awk '{print $5}')
Name=$(curl -sS https://raw.githubusercontent.com/halonthe/permission/main/ip | grep $MYIP | awk '{print $2}')
Exp=$(curl -sS https://raw.githubusercontent.com/halonthe/permission/main/ip | grep $MYIP | awk '{print $3}')
...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/halonthe/update/main/update.sh" && chmod +x /root/update.sh
sleep 2
./update.sh
sleep 5
rm /root/update.sh
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/halonthe/permission/main/version)
